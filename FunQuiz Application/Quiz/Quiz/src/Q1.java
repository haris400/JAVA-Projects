...
public class Q1 extends Home{
	Stage stage =new Stage();
	Q1(){
		stage.setTitle("Question No : 1");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root){
		final Label lbl = new Label("QUESTION NO: 1");
		...
		text.setText("There are five birds sitting on electric wire. Two were shot and killed by a hunter. How many are left?"); 

		text.setX(30); 
	    text.setY(200);   
	    
	    DropShadow shadow = new DropShadow();
	    Button btn1 = new Button("5 birds");
		...
		Button btn2 = new Button("2 birds");
		...
		Button btn3 = new Button("0 birds");
		...
		Button btn4 = new Button("3 birds");

...
public class Q5 extends Home{
	Stage stage =new Stage();
	Q5(){
		stage.setTitle("Question No : 5");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		// TODO Auto-generated method stub
			...
			final Label lbl = new Label("QUESTION NO: 5");
			...
			text.setText("What falling object is said to have inspired Isaac Newton's theories about gravity?"); 
			text.setX(120); 
		    text.setY(200);   

...
public class Q4 extends Home{
	Stage stage =new Stage();
	Q4(){
		stage.setTitle("Question No : 4");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		// TODO Auto-generated method stub
			...
			final Label lbl = new Label("QUESTION NO: 4");
			...
			text.setText("A magician said if anybody can be under water for 10 minutes, he'll give them $100,000.\n         A young boy volunteered and won. How is that possible?"); 
			text.setX(120); 
		    text.setY(200);   
		    ...
		    Button btn1 = new Button("He got a cup of water and put it on his head so he is under water");
			...
			Button btn2 = new Button("He went in a swimming pool and did it");
			...
			Button btn3 = new Button("He stole it");
			btn3.setFont(new Font("Book Antiqua", 25));
			btn3.setTranslateX(800);
			...
			Button btn4 = new Button("He cheated and won");
			btn4.setFont(new Font("Book Antiqua", 25));
			btn4.setTranslateX(750);
			...
			btn2.setOnAction((ActionEvent e) -> {
				  ...
				  alert.setTitle("Information Dialog");
				  alert.setHeaderText(null);
				  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.\n Correct Answer Was: He got a cup of water\nand put it on his head so he is under water");

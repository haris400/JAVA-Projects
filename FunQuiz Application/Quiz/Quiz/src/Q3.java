...
public class Q3 extends Home{
	Stage stage =new Stage();
	Q3(){
		stage.setTitle("Question No : 3");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		// TODO Auto-generated method stub
			...
			final Label lbl = new Label("QUESTION NO: 3");
			...
			text.setText("Jim's peacock laid an egg on Bobby's lawn. Who's egg is it?"); 
			text.setX(220); 
		    text.setY(200);   
		    ...
		    Button btn1 = new Button("Nobody. Peacocks don't lay eggs. Peahens do");
			...
			Button btn2 = new Button("The Peacocks because it was the one who laid the egg");
			...
			Button btn3 = new Button("Bobby's because its on his lawn");
			...
			Button btn4 = new Button("I Don't know");
			...
			btn2.setOnAction((ActionEvent e) -> {
				  ...
				  alert.setTitle("Information Dialog");
				  alert.setHeaderText(null);
				  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.\\n Correct Answer Was: Nobody. Peacocks don't lay eggs. Peahens do");

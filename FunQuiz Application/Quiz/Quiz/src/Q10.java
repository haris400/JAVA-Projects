...
public class Q10 extends Home{
	Stage stage =new Stage();
	Q10(){
		stage.setTitle("Question No : 10");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		...
		final Label lbl = new Label("QUESTION NO: 10");
	...
	text.setText("If you pass the 2nd person in a race what will you be coming?"); 
	text.setX(230); 
    text.setY(200);   
	...
	btn1.setOnAction((ActionEvent e) -> {
		  ...
		  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.Correct Answer Was: 2nd");
		  alert.showAndWait();
		  if(Lives == 0)
		  {

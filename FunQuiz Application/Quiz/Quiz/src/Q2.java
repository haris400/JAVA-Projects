...
public class Q2 extends Home {
	Stage stage =new Stage();
	Q2(){
		stage.setTitle("Question No : 2");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		// TODO Auto-generated method stub
			...
			final Label lbl = new Label("QUESTION NO: 2");
			...
			text.setText("What's 1+2+3+4+5+6+.....+98+99+100? "); 
			text.setX(320); 
		    text.setY(200);   
			...
			Button btn2 = new Button("12345678910");

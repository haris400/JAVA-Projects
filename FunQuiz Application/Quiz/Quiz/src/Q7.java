...
public class Q7 extends Home {
	Stage stage =new Stage();
	Q7(){
		stage.setTitle("Question No : 7");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		...
		final Label lbl = new Label("QUESTION NO: 7");
	...
	text.setText("If you drop a yellow hat in the red sea what does it became ?"); 
	text.setX(200); 
    text.setY(200);   
	...
	btn1.setOnAction((ActionEvent e) -> {
		  ...
		  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.Correct Answer Was: Wet");
		  alert.showAndWait();
		  if(Lives == 1)
		  {

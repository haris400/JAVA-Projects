...
public class Q9 extends Home{
	Stage stage =new Stage();
	Q9(){
		stage.setTitle("Question No : 9");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		...
		final Label lbl = new Label("QUESTION NO: 9");
	...
	text.setText("Which of the following book is famous all over the world?"); 
	text.setX(280); 
    text.setY(200);   
    ...
    Button btn1 = new Button("Arts book");
	...
	Button btn2 = new Button("Science book");
	...
	Button btn3 = new Button("Commerce book ");
	...
	Button btn4 = new Button("Facebook");
	...
	btn1.setOnAction((ActionEvent e) -> {
		  ...
		  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.Correct Answer Was: Facebook");
		  alert.showAndWait();
		  if(Lives == 1)
		  {

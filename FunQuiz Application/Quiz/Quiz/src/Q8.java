...
public class Q8 extends Home{
	Stage stage =new Stage();
	Q8(){
		stage.setTitle("Question No : 8");
		stage.setWidth(1100);
		stage.setHeight(700);
	...
	void addComponents(Group root) {
		...
		final Label lbl = new Label("QUESTION NO: 8");
	...
	text.setText("Which is the most expenssive gate?"); 
	text.setX(355); 
    text.setY(200);   
    ...
    Button btn1 = new Button("Colgate");
	...
	Button btn2 = new Button("Bill gates");
	...
	Button btn3 = new Button("Machine Gate");
	...
	Button btn4 = new Button("Electornic Gate");
	...
	btn1.setOnAction((ActionEvent e) -> {
		  ...
		  alert.setContentText("Your Answer is Wrong,\n Click Ok for next Question.Correct Answer Was: Bill gates");
		  alert.showAndWait();
		  if(Lives == 1)
		  {
